...
class JiraHelper:
    ...
    def get_component_manager(self, issue, fields='components,customfield_12713'):
        ...
        if hasattr(issue.fields, 'customfield_12713') and getattr(issue.fields, 'customfield_12713') is not None:
            result['component_manager'] = getattr(issue.fields, 'customfield_12713').displayName
        else:
            result['component_manager'] = 'NA'
        return result

    def get_issues(self, query, max_results=None):
